...
def invalid_messages(context: DurableContext, scope: StepScope) -> None:
    context.log.information("wrong method")  # type: ignore[attr-defined]  # pyright: ignore[reportAttributeAccessIssue, reportUnknownMemberType]
    scope.log.info("wrong option", extras={"operation": "charge"})  # type: ignore[call-arg]  # pyright: ignore[reportCallIssue]
