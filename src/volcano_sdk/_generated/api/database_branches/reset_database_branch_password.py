...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{id}/databases/{database_name}/branches/{branch_name}/reset-password".format(id=quote(str(id), safe=""),database_name=quote(str(database_name), safe=""),branch_name=quote(str(branch_name), safe=""),),
    }
