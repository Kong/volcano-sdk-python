...
from ...models.update_database_branch_request import UpdateDatabaseBranchRequest
...
def _get_kwargs(
    ...
    branch_name: str,
    *,
    body: UpdateDatabaseBranchRequest,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> DatabaseBranch | Error | None:
    if response.status_code == 200:
        response_200 = DatabaseBranch.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        database_name (str):
        branch_name (str):
        body (UpdateDatabaseBranchRequest): Replace the branch's lifetime and restart its
            countdown from now.
