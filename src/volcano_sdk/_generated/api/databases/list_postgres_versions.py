...
from ...models.list_postgres_versions_response_200_item import ListPostgresVersionsResponse200Item
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> list[ListPostgresVersionsResponse200Item] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = ListPostgresVersionsResponse200Item.from_dict(response_200_item_data)
