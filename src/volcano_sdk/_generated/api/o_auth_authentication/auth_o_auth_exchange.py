...
from ...models.auth_o_auth_exchange_body import AuthOAuthExchangeBody
...
def build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Any | AuthTokenResponse]:
    return Response(
