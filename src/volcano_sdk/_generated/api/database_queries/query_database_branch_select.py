...
from ...models.database_select_request import DatabaseSelectRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/databases/{database_name}/branches/{branch_name}/query/select".format(database_name=quote(str(database_name), safe=""),branch_name=quote(str(branch_name), safe=""),),
    }
