...
def request_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{id}/durable-functions/{function_id}/deployments".format(id=quote(str(id), safe=""),function_id=quote(str(function_id), safe=""),),
        "params": params,
    }
...
def build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | PaginatedFunctionDeployments]:
    return Response(
