...
from ...models.paginated_functions import PaginatedFunctions
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | PaginatedFunctions | None:
    if response.status_code == 200:
        response_200 = PaginatedFunctions.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | PaginatedFunctions]:
    return Response(
...
) -> Response[Error | PaginatedFunctions]:
