...
from ...models.upload_project_logo_body import UploadProjectLogoBody
...
def build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | Project]:
    return Response(
