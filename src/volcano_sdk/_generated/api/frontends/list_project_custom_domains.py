...
from ...models.paginated_project_custom_domains import PaginatedProjectCustomDomains
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{id}/domains".format(id=quote(str(id), safe=""),),
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | PaginatedProjectCustomDomains | None:
    if response.status_code == 200:
        response_200 = PaginatedProjectCustomDomains.from_dict(response.json())
