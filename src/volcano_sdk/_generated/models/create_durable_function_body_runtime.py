...
CreateDurableFunctionBodyRuntime = Literal['nodejs22.x', 'nodejs24.x', 'python3.13', 'python3.14']

CREATE_DURABLE_FUNCTION_BODY_RUNTIME_VALUES: set[CreateDurableFunctionBodyRuntime] = { 'nodejs22.x', 'nodejs24.x', 'python3.13', 'python3.14',  }
