...
T = TypeVar("T", bound="FunctionSchedulerListResponse")



@_attrs_define
class FunctionSchedulerListResponse:
    """ 
        Attributes:
            data (list[FunctionScheduler]):
            page (int):
            limit (int):
            total (int):
            has_more (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = FunctionScheduler.from_dict(data_item_data)
        ...
        function_scheduler_list_response = cls(
            data=data,
            page=page,
            limit=limit,
            total=total,
        ...
        function_scheduler_list_response.additional_properties = d
        return function_scheduler_list_response
