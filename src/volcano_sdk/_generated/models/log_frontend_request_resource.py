...
from ..models.log_frontend_request_resource_type import check_log_frontend_request_resource_type
from ..models.log_frontend_request_resource_type import LogFrontendRequestResourceType
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="LogFrontendRequestResource")



@_attrs_define
class LogFrontendRequestResource:
    """ Frontend log resource selector.

        Attributes:
            type_ (LogFrontendRequestResourceType): Resource type to read logs for.
            ids (list[UUID] | Unset): Optional frontend identifiers. Omit or send an empty array to include every frontend
                in the project.
            deployments (LogDeploymentRequestSelector | Unset): Deployment log selector for deployable resources.
     """

    type_: LogFrontendRequestResourceType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_frontend_request_resource = cls(
            type_=type_,
            ids=ids,
            deployments=deployments,
        )

        return log_frontend_request_resource
