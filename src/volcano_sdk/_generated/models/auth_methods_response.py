...
T = TypeVar("T", bound="AuthMethodsResponse")
...
class AuthMethodsResponse:
    """ 
        Attributes:
            methods (list[AuthMethodSummary]):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for methods_item_data in (_methods):
            methods_item = AuthMethodSummary.from_dict(methods_item_data)
        ...
        auth_methods_response = cls(
            methods=methods,
        )


        auth_methods_response.additional_properties = d
        return auth_methods_response
