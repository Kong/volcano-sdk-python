...
class Database:
    """ PostgreSQL database with automatic scalability and security features.
        ...
        Attributes:
            ...
            status (DatabaseStatus): Database status. `restoring` means a restore is replacing the
            ...
            storage_bytes (int | Unset): Latest observed storage for this database, in bytes: its own on-disk
