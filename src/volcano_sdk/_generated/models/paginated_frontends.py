...
T = TypeVar("T", bound="PaginatedFrontends")



@_attrs_define
class PaginatedFrontends:
    """ 
        Attributes:
            data (list[Frontend]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = Frontend.from_dict(data_item_data)
        ...
        paginated_frontends.additional_properties = d
        return paginated_frontends
