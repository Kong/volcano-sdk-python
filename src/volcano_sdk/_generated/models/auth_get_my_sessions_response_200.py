...
T = TypeVar("T", bound="AuthGetMySessionsResponse200")



@_attrs_define
class AuthGetMySessionsResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_get_my_sessions_response_200 = cls(
            sessions=sessions,
            total=total,
            page=page,
            limit=limit,
        ...
        auth_get_my_sessions_response_200.additional_properties = d
        return auth_get_my_sessions_response_200
