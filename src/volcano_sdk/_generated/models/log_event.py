...
class LogEvent:
    """ Historical log event returned by log APIs.
        ...
        Attributes:
            ...
            id (str | Unset): Opaque stable log event ID for pagination, deduplication, and display.
            ...
            resource (LogResource | Unset): Resource that owns a historical log event.
    ...
    resource: LogResource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource: LogResource | Unset
        if isinstance(_resource,  Unset):
            resource = UNSET
        else:
            resource = LogResource.from_dict(_resource)
