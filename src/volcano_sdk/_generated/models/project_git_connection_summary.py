...
T = TypeVar("T", bound="ProjectGitConnectionSummary")



@_attrs_define
class ProjectGitConnectionSummary:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_git_connection_summary = cls(
            repo_installation_id=repo_installation_id,
            repo_id=repo_id,
            repo_full_name=repo_full_name,
            root_directory=root_directory,
        ...
        project_git_connection_summary.additional_properties = d
        return project_git_connection_summary
