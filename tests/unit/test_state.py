...
from fixtures.invalid_arguments import (
    mutate_frozen_page,
    mutate_frozen_provider,
    mutate_frozen_token_status,
    non_session_adoption,
    unknown_oauth_api_provider,
    unknown_oauth_link_provider,
    unknown_oauth_refresh_provider,
    unknown_oauth_sign_in_provider,
    unknown_oauth_token_provider,
    unknown_oauth_unlink_provider,
...
def test_list_linked_oauth_providers_returns_immutable_values() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        mutate_frozen_provider(result[0])
...
def test_sign_in_with_oauth_rejects_an_unknown_provider() -> None:
    ...
    with pytest.raises(ValueError, match="Unsupported OAuth provider"):
        unknown_oauth_sign_in_provider(client.auth)
...
def test_link_oauth_provider_rejects_an_unknown_provider() -> None:
    ...
    with pytest.raises(ValueError, match="Unsupported OAuth provider"):
        unknown_oauth_link_provider(client.auth)
...
def test_unlink_oauth_provider_rejects_an_unknown_provider() -> None:
    ...
    with pytest.raises(ValueError, match="Unsupported OAuth provider"):
        unknown_oauth_unlink_provider(client.auth)
...
def test_get_oauth_provider_token_returns_immutable_status() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        mutate_frozen_token_status(result)
...
def test_get_oauth_provider_token_rejects_an_unknown_provider() -> None:
    ...
    with pytest.raises(ValueError, match="Unsupported OAuth provider"):
        unknown_oauth_token_provider(client.auth)
...
def test_refresh_oauth_provider_token_rejects_an_unknown_provider() -> None:
    ...
    with pytest.raises(ValueError, match="Unsupported OAuth provider"):
        unknown_oauth_refresh_provider(client.auth)
